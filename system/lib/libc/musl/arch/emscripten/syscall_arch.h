...
long __syscall_truncate(long path, long zero, long low, long high);
long __syscall_ftruncate(long fd, long zero, long low, long high);
long __syscall_stat(long path, long buf);
long __syscall_lstat(long path, long buf);
long __syscall_fstat(long fd, long buf);
...
long __syscall_fcntl(long fd, long cmd, ...);
...
long __syscall_fstatat(long dirfd, long path, long buf, long flags);
