...
#else // __EMSCRIPTEN__
#define __syscall_emscripten(n, ...) __syscall_##n(__VA_ARGS__)
...
#endif
#else // __EMSCRIPTEN__
#define __sys_open2(x,pn,fl) __SYSCALL_CONCAT(__syscall_, SYS_open)(__scc(pn), __scc((fl)|O_LARGEFILE))
#define __sys_open3(x,pn,fl,mo) __SYSCALL_CONCAT(__syscall_, SYS_open)(__scc(pn), __scc((fl)|O_LARGEFILE), __scc(mo))
#define __sys_open_cp2(x,pn,fl) __SYSCALL_CONCAT(__syscall_, SYS_open)(__scc(pn), __scc((fl)|O_LARGEFILE))
#define __sys_open_cp3(x,pn,fl,mo) __SYSCALL_CONCAT(__syscall_, SYS_open)(__scc(pn), __scc((fl)|O_LARGEFILE), __scc(mo))
#endif
